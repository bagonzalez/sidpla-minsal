...
//                $fillManager = new JavaClass("net.sf.jasperreports.engine.JasperFillManager");
    ...
    public function reporteInfraEvaluadaAction() {
        $request = $this->getRequest();
        $JustiPao = $request->get('infraEvaluada');
        $id = $request->get('id');
        ...
        try {
            ...
            $params = new Java("java.util.HashMap");
            $params->put("infraEvaluada", new java("java.lang.Integer", $id)); //asignando valor al parametro
    ...
    public function reporteConsolidadoNivelCentralAction() {
        ...
        try {
            ...
            // $params->put("anio", new java("java.lang.Integer", $anio));//asignando valor al parametro
            $Conn = $this->crearConexion();
            //se llena el reporte con la informacion y parametros 
            $jasperPrint = $fillManager->fillReport($report, $params, $Conn);
            $outputPath = realpath(".") . "/" . "output.pdf"; //mostrar el reporte en pdf
